...
const ResumeCard = ({resume}:{resume:Resume}) => {
  ...
  return (
    <Link to={`/resume/${resume.id}`} className='resume-card animate-in fade-in duration-3000'>
        ...
        {resumeUrl && (<div className='gradient-border animate-in fade-in duration-3000'>
